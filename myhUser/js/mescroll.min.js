...
MeScroll.prototype.extendUpScroll = function(a) {
	...
	MeScroll.extend(a, {
		...
		htmlLoading: '<p class="upwarp-progress mescroll-rotate"></p><p class="upwarp-tip">載入中..</p>',
		htmlNodata: '<p class="upwarp-nodata">-- 沒有更多了 --</p>',
		inited: function(c, d) {},
