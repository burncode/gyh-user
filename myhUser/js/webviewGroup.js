...
proto._init = function() {
	this._initParent();
	this._initNativeView(this.options.top);
...
proto._initNativeView = function(top) {
	top = top;
	...
	this.nativeView = new plus.nativeObj.View('__MUI_TAB_NATIVE', {
		'top': (top + statusbar_H) +'px', //这个需要根据顶部导航及顶部选项卡高度自动调整
		'height': (window.screen.height - top)+"px",
		'left': '100%',
		'width': '100%',
